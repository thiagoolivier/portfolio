export const pt_BR = {
  ...
  about: {
    ...
    p5: "Atualmente, trabalho como Desenvolvedor Full Stack em um provedor de internet chamado Brasil Digital Telecom.",
  },
  projects: {
    title: "Projetos",
    portfolio: {
    ...
    myerp: {
      title: "MyERP",
      details:
        "Um sistema de gestão empresarial escalávele para pequenas empresas.",
      thumbnail: "projects/my_erp/thumbnail.png",
      thumbnailAlt: "Imagem do projeto MyERP.",
      pdf: "projects/my_erp/ptbr/project.pdf",
    },
    tfitness: {
      title: "TFitness",
